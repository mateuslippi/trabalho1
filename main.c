...
int main()
{
    ...
    case 1:
        ...
        soma = valor1 + valor2;
        printf("\n");
        printf("O resultado da soma de %.2f e %.2f é: %.2f", valor1, valor2, soma);
        break;
    ...
    case 2:
        ...
        printf("\n");
        printf("O resultado da subtração de %.2f e %.2f é: %.2f", valor1, valor2, subtracao);
        break;
    ...
    case 3:
        ...
        printf("\n");
        printf("O resultado da multiplicação de %.2f e %.2f é: %.2f", valor1, valor2, multiplicacao);
        break;
    ...
    case 4:
        ...
        if (valor2 != 0) {
            ...
            printf("\n");
            printf("O resultado da divisão de %.2f e %.2f é: %.2f", valor1, valor2, divisao);
        }
        else {
            printf("\n");
            printf("Inválido, escolha um valor diferente de 0.");
        }
        break;
    ...
    case 5:
        ...
        printf("\n");
        printf("O resultado da potencia de %.2f e %.2f é: %.2f", valor1, valor2, potencia);
        break;
    ...
    case 6:
        ...
        scanf("%f", &valor1);
        raiz = sqrt(valor1);
        printf("A raiz quadrada de %.2f é: %.2f", valor1, raiz);
        break;
